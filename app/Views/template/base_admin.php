...
<head>
  ...
  <title>Dashboard | Desa Ekspor Indonesia</title>
  ...
  <!-- Main CSS File -->
  <link href="assets/css/pages/admin.css" rel="stylesheet">
</head>
...
<!-- ======= Footer ======= -->
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>A2J</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      Designed by <a href="http://alfigantenk.com">A2J</a>
    </div>
  </footer><!-- End Footer -->
  ...
  <!-- Main JS File -->
  <script src="<?= base_url('assets/js/pages/admin.js'); ?>"></script>
  <script src="<?= base_url('https://cdn.datatables.net/1.11.3/js/jquery.dataTables.min.js'); ?>"></script>
  <script src="<?= base_url('https://cdn.datatables.net/1.11.3/js/dataTables.bootstrap5.min.js'); ?>"></script>
</body>
