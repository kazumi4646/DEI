    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li class="dropdown"><a href="<?= base_url('/shop'); ?>"><span>Shop</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                ...
                <li class="dropdown">
                    <a href="<?= base_url('/profile'); ?>" class="active d-md-block d-none align-items-center">
                        <span><i class="bi bi-person-bounding-box fs-4"></i></span>
                    </a>
                    <a href="<?= base_url('/profile'); ?>" class="d-md-none active">
                        Profile <i class="bi bi-chevron-down"></i>
                    </a>
                    <ul>
                        <li><a class="active" href="<?= base_url('/profile'); ?>"><?= user()->username; ?></a></li>
                        <hr class="my-0">
                        <li><a class="active" href="<?= base_url('/profile'); ?>">My Profile</a></li>
